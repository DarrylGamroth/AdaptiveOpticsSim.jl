...
function _resolve_scale(name::AbstractString)
    ...
    if lowered == "compact"
        return (
            ...
            wind_direction_deg=Float32[0.0, 90.0],
    ...
    elseif lowered == "medium"
        return (
            ...
            wind_direction_deg=Float32[0.0, 60.0, 120.0],
    ...
    return (
        ...
        wind_direction_deg=Float32[0.0, 45.0, 90.0, 135.0],
...
function _sync_array!(::Type{B}, A) where {B<:AdaptiveOpticsSim.Backends.GPUBackendTag}
