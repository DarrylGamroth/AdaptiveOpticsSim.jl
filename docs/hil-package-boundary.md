...
| WFS composition | Shack–Hartmann separates microlens optics, layout/calibration, acquisition, and estimation. Pyramid and BioEdge now expose physically distinct focal-plane front ends over shared prepared modulation, family-neutral detector acquisition, and revision-bound differential estimators. All three form explicit photon-rate products and preserve spectral or path-local source products as bundles | Complete the same prepared optical-front-end, acquisition, and estimator separation for Zernike/Curvature and LiFT |
