...
| WFS composition | Shack–Hartmann now separates microlens optics, layout/calibration, acquisition, and estimation over explicit photon-rate products, retaining distinct wavelength grids as bundles; the remaining WFS families still combine these responsibilities internally | Complete the same prepared optical-front-end, acquisition, and estimator separation for Pyramid/BioEdge, Zernike/Curvature, and LiFT |
