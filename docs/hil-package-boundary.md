...
| Controllable optics | Named independent optics and endpoints have versioned schemas, bounded late/future/silence policy, additive co-conjugated application, explicit transactions, and zero-copy prepared controller-output routing. All are currently treated as one common all-path optical group | Add explicit conjugate placement, transforms, and path visibility |
