...
| HIL-FAIL-001 | 8 | Required and optional work have declared shed, stop, failure, and recovery behavior without runtime provider substitution | HIL | partial | partial | Gate 8.5 prepares independent stable owners without runtime provider substitution, and its focused [owner tests](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/blob/f1f7c5cef4ea09d7d30f3e89b7c0bb406d571e49/test/execution.jl) demonstrate that an already-materialized optional science owner may stall while an independent required WFS owner completes. Owner failures have a typed failed phase and are included in run accounting. The evidence does not yet define due-ring-full shed/stop policy, ingress overload, recovery, or terminal disposition for every already-admitted command; those obligations remain [AdaptiveOpticsHIL #23](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/issues/23). |
