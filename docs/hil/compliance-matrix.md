...
| 4 | Independent controllable-optic and meaningful reduced-order command semantics | partial |
...
Status: in progress. Independent endpoints, schemas, application, silence,
...
implemented. Only the final cross-backend closure remains.
