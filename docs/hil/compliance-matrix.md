...
| HIL-RING-001 | 8 | Each hot ownership handoff uses a bounded SPSC descriptor ring with release/acquire publication and isolated cursors | HIL | planned | missing | Requires layout, generated-code, concurrency, saturation, and recovery evidence. Delivery is tracked by [AdaptiveOpticsHIL #18](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/issues/18). |
