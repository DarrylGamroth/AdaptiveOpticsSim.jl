...
grouping, native-DM MCAO/MOAO composition, and exact reduced-order visibility
are implemented and validated. Sampled NCPA attachment remains open.
...
- attach sampled NCPA and static aberrations to explicit paths next
