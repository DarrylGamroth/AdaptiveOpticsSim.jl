...
evidence for the REVOLT-like boundary. They do not close the transitional
`LegacyTelescopePathState` gap in `HIL-PLANE-001`, claim external-RTC response
time, or replace the earlier maintained AMD latency characterization.
