...
7.6 still owns promoted hardware service-cost evidence and final single-GPU
support closure; it may not relabel the focused correctness matrix as latency
