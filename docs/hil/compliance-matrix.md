...
| HIL-PORT-001 | 4A | Canonical command-submission, command-completion/outcome, and acquisition-completion ports are transport-neutral | HIL | implemented | validated | AdaptiveOpticsHIL [`Ports`](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/blob/32c0db8d26d82b344d91ad68b8cc317e3104f1ad/src/ports.jl) owns concrete nonblocking command-submission, command-outcome, and complete-acquisition contracts without a transport dependency. [`ports.jl` tests](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/blob/32c0db8d26d82b344d91ad68b8cc317e3104f1ad/test/ports.jl) distinguish transfer from semantic admission and cover full, empty, closed, rejection, correlation, and terminal-credit behavior; the serial and benchmark evidence exercises all three ports together. General full/close/drain/recovery semantics and hardened padded rings remain Gate 8. |
...
| HIL-BUF-001 | 4A | Large acquisition and command payloads use bounded pools and explicit generation-checked leases rather than ring-resident payload copies | HIL + user integration | implemented | validated | AdaptiveOpticsHIL [`Ownership`](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/blob/32c0db8d26d82b344d91ad68b8cc317e3104f1ad/src/ownership.jl) provides fixed-capacity caller-supplied payload pools, compact lease references, generation and owner/session checks, and explicit producer/queued/consumer/free transitions. Command and acquisition descriptors carry lease references rather than array payloads. Focused [ownership](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/blob/32c0db8d26d82b344d91ad68b8cc317e3104f1ad/test/ownership.jl), [concurrency](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/blob/32c0db8d26d82b344d91ad68b8cc317e3104f1ad/test/ownership_concurrency.jl), and [port](https://github.com/DarrylGamroth/AdaptiveOpticsHIL.jl/blob/32c0db8d26d82b344d91ad68b8cc317e3104f1ad/test/ports.jl) tests cover reuse, stale/foreign/duplicate release, leased array commands, and complete products; the artifact ends every run quiescent. Gate 8 still owns reserved return-path credit, cache-line layout, generated-code, lifecycle, recovery, and full `HIL-RING-001` hardening. |
...
the still-planned port-lifecycle, return-credit, worker, failure, or operational
