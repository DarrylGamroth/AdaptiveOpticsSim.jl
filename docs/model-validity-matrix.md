...
| `MV-03` | WFS optical and retained estimation families | `A, R, G, P, M` — [`wfs_common_and_parity.jl`](../test/testsets/wfs_common_and_parity.jl), [`shack_hartmann_and_sources.jl`](../test/testsets/shack_hartmann_and_sources.jl), [`pyramid_bi_o_edge_and_lgs.jl`](../test/testsets/pyramid_bi_o_edge_and_lgs.jl), [`zernike_and_curvature.jl`](../test/testsets/zernike_and_curvature.jl), [`wfs_lift.jl`](../test/testsets/wfs_lift.jl), [`backend_optional_common.jl`](../test/backend_optional_common.jl), and the [LiFT AOS/AOC profile](../benchmarks/results/platform/2026-09-22-lift-aoc-adapter-profile.toml) | Shack–Hartmann, Pyramid, Bi-O-edge, Zernike, and Curvature coverage ends at physical optical formation and complete detector observations; maintained operational estimation is qualified in the registered FGA/JFG fixtures. LiFT physical prediction and analytic Jacobians remain in AOS; the registered AdaptiveOpticsCalibration v0.10 inverse is exercised with that live model on CPU, CUDA, and AMDGPU. The old AOS LiFT inverse remains during the separate consumer-deletion gate. Weighted-centroid processing is not an AOS capability or validity claim. Instrument-specific optical gain and non-common-path calibration remain external. | strong for declared numerical models and ownership boundaries |
