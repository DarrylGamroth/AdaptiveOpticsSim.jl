...
| `MV-14` | Controllable optics and composite low-order runtime plants | `A`, `G`, `P`, `M` | deterministic CPU self-check artifacts + backend parity | [control_and_runtime.jl](../test/testsets/control_and_runtime.jl), [backend_optional_common.jl](../test/backend_optional_common.jl), [gpu_runtime_equivalence_contract.jl](../scripts/gpu_runtime_equivalence_contract.jl), [generate_multi_optic_runtime_artifact.jl](../scripts/generate_multi_optic_runtime_artifact.jl), [controllable-optic-self-check-plan-2026-04.md](./controllable-optic-self-check-plan-2026-04.md), [platform-orchestration-validation.md](./platform-orchestration-validation.md), [backend-validation-guide.md](./backend-validation-guide.md), [2026-04-13-multi-optic-hil.toml](../benchmarks/results/platform/2026-04-13-multi-optic-hil.toml) | Current maintained evidence is internal physics validation plus backend parity for `tiptilt + dm`, `steering + dm`, and `focus + dm` runtime plants. This is intentionally stronger than raw smoke parity, but it is not yet an external OOPAO or SPECULA equivalence claim for those composite plants | strong |
