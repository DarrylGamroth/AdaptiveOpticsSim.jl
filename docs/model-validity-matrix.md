...
| `MV-10` | Tomography and reconstruction | `A`, `R`, `G`, `M` | pyTomoAO / OOPAO-adjacent frozen references | [tomography.jl](../test/tomography.jl), [reference_harness.jl](../test/reference_harness.jl), [reference_data](../test/reference_data), tomography GPU profile scripts under [scripts](../scripts), [tomography-benchmark-scope.md](./tomography-benchmark-scope.md) | Frozen reference and functional coverage remain strong, but a routinely refreshable representative benchmark artifact is explicitly deferred and documented | medium-strong |
...
| `MV-13` | Grouped runtime and multi-source / multi-WFS orchestration | `A`, `G`, `P`, `M` | Julia-first grouped runtime artifact | [control_and_runtime.jl](../test/testsets/control_and_runtime.jl), [profile_multi_source_multi_wfs_runtime.jl](../scripts/profile_multi_source_multi_wfs_runtime.jl), [grouped-runtime-contract.md](./grouped-runtime-contract.md), [grouped-runtime-validation.md](./grouped-runtime-validation.md), [2026-04-01-gr.toml](../benchmarks/results/grouped/2026-04-01-gr.toml) | This is explicit grouped-runtime evidence for Julia-side orchestration and export ownership, not a claim of SPECULA equivalence yet | medium-strong |
