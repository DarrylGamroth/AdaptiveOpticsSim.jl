...
| `MV-06` | Tomography | `A, M` — [`tomography.jl`](../test/tomography.jl) | Guide-star/layer geometry, cold model- and interaction-matrix reconstruction, sampled DM fitting, and command-matrix assembly. FilterGraphAlgorithms/JuliaFilterGraph owns per-frame matrix application. Instrument MCAO/MOAO calibration remains scenario work. | implemented; external equivalence partial |
