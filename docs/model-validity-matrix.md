...
| `MV-03` | WFS optical and retained estimation families | `A, R, G, M` — [`wfs_common_and_parity.jl`](../test/testsets/wfs_common_and_parity.jl), [`shack_hartmann_and_sources.jl`](../test/testsets/shack_hartmann_and_sources.jl), [`pyramid_bi_o_edge_and_lgs.jl`](../test/testsets/pyramid_bi_o_edge_and_lgs.jl), [`zernike_and_curvature.jl`](../test/testsets/zernike_and_curvature.jl), [`wfs_lift.jl`](../test/testsets/wfs_lift.jl) | Shack–Hartmann, Pyramid, Bi-O-edge, Zernike, and Curvature coverage ends at physical optical formation and complete detector observations; maintained operational estimation is qualified in the registered FGA/JFG fixtures. LiFT retains its tested AOS forward and phase-retrieval workflow until its approved AdaptiveOpticsCalibration inverse target is released and adopted. Weighted-centroid processing is not an AOS capability or validity claim. Instrument-specific optical gain and non-common-path calibration remain external. | strong for declared numerical models and ownership boundaries |
