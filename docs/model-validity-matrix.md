...
| `MV-04` | Detectors and detector-family execution | `A`, `G`, `P`, `M` | analytic + runtime behavior | [runtests.jl](../test/runtests.jl), [optional_gpu_backends.jl](../test/optional_gpu_backends.jl), [profile_ao3k_runtime.jl](../scripts/profile_ao3k_runtime.jl) | Detector realism is strongest in integrated runtime scenarios; family-specific frozen detector references remain limited | medium |
...
| `MV-11` | GPU backend execution policy | `G`, `P`, `M` | backend parity | [optional_gpu_backends.jl](../test/optional_gpu_backends.jl), [gpu_smoke_contract.jl](../scripts/gpu_smoke_contract.jl), [profile_ao3k_runtime.jl](../scripts/profile_ao3k_runtime.jl), [profile_multi_source_multi_wfs_runtime.jl](../scripts/profile_multi_source_multi_wfs_runtime.jl), [gpu-runtime-structural-refactor-plan.md](./gpu-runtime-structural-refactor-plan.md) | Backend evidence is strong, but still spread across functional tests, smoke, and benchmarks rather than one tutorial-style guide | strong |
