...
| `MV-08` | LiFT and gain-sensing camera | `A`, `R`, `G`, `P`, `M` | OOPAO + maintained workflow and Gate 0 artifacts | [reference_harness.jl](../test/reference_harness.jl), [reference_data](../test/reference_data), [calibration_and_analysis.jl](../test/testsets/calibration_and_analysis.jl), [backend_optional_common.jl](../test/backend_optional_common.jl), [2026-04-01-phase1-pvp05.toml](../benchmarks/results/workflows/2026-04-01-phase1-pvp05.toml), [Gate 0 LiFT artifact](../benchmarks/results/gate0/2026-07-18-pre-hil-10-lift.toml) | LiFT now separates an immutable optical definition and single-writer forward workspace from independently acquired caller-owned observations and iterative estimation. The forward model predicts a monochromatic, angular-coordinate, cell-integrated photon-arrival rate with explicit deterministic response/sampling/binning; rate, expected-count, and normalized-intensity observations convert explicitly to the canonical rate domain. Frozen analytic/numerical Jacobian norms, coefficient recovery, weighting/damping policies, object kernels, mismatch rejection, Float32, and zero-allocation normal-equation execution are covered on CPU. The optional matrix exercises device-resident forward, dense/separable convolution, and estimation with scalar indexing disabled; the current-revision CUDA/AMDGPU evidence is completed by the dedicated Gate 0 hardware pass rather than inferred from CPU tests. The GSC remains a separate focal-plane calibration workflow rather than part of LiFT acquisition. | strong |
