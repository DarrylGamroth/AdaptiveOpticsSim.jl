...
full CPU suite passed, the maintained CUDA target passed `406/406`, and the
maintained AMDGPU target passed `416/416`. Clean REVOLT-like correctness,
...
multi-rate HIL scheduling or external-RTC timing evidence. The transitional
frame-step runtime still assigns noisy detector draws through one sequential
runtime RNG. In contrast, the schedule-free prepared plant derives exact
