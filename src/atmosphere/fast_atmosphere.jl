#
# Atmosphere timing helpers
#
# `fast_atmosphere` preserves the physical atmosphere parameters while reducing
# the telescope sampling time by a requested speed factor.
#
