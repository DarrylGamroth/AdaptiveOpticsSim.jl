...
@inline function _measure_for_calibration!(wfs::ShackHartmann{<:Diffractive}, tel::Telescope, src::AbstractSource)
    prepare_sampling!(wfs, tel, src)
    ensure_sh_calibration!(wfs, tel, src)
    return measure!(wfs, tel, src)
end

@inline function _measure_for_calibration!(wfs::ShackHartmann{<:Diffractive}, tel::Telescope, src::SpectralSource)
