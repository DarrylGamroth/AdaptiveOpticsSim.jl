...
@testset "Closed-loop runtime" begin
    ...
    sim_ext = AOSimulation(tel_ext, atm_ext, src_ext, dm_ext, wfs_ext)
    ...
    sim2b = AOSimulation(tel2b, atm2b, src2b, dm2b, wfs2b)
    ...
    combo_sim = AOSimulation(tel_ext, atm_ext, src_ext, combo_optic, wfs_ext)
    ...
    focus_sim = AOSimulation(tel_ext, atm_ext, src_ext, focus_optic, wfs_ext)
