...
function main(; resolution::Int=24, zero_padding::Int=2)
    ...
    native = Detector(noise=NoiseNone(), exposure_duration=1.0, qe=1.0, psf_sampling=1, binning=1)
    sampled = Detector(noise=NoiseNone(), exposure_duration=1.0, qe=1.0, psf_sampling=2, binning=2)
