...
# Exact nonzero payload shared by these two source artifacts:
#
...
#
# The raw files have different headers but identical 19-by-19 command-index
# payloads. This module retains the source-file row order. Command indices
...
maintained on-sky and Copper source artifacts; they do not by themselves define
a normalized-pupil orientation.
"""
