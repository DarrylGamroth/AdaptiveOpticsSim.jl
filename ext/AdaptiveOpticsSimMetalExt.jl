...
AdaptiveOpticsSim.gpu_backend_name(::Type{AdaptiveOpticsSim.MetalBackendTag}) = :metal
...
AdaptiveOpticsSim.disable_scalar_backend!(::Type{AdaptiveOpticsSim.MetalBackendTag}) = Metal.allowscalar(false)
